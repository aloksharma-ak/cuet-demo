...
const ShineScholarship = () => {
  const heroData = {
    title: (
      <>
        Achieve Excellence with the <span>Shine</span> Scholarship Test
      </>
    ),
    description: `Your journey to India’s top universities starts here. Achieve academic
          ...
          way for your dreams.`,
    buttonText: "Apply Now for the CUET Shine Scholarship",
  ...
  const prizeData = {
    ...
    whoCanApply: [
      "Students Preparing for their 12th board exams alongside CUET.",
  ...
  const opportunitiesData = {
    heading: {
      ...
      desc: ` The Shine Scholarship Test is a merit-based online exam designed
    ...
    cards: [
      {
        ...
        title: "TOP ACHIEVERS",
        items: [
          "100% tuition fee waiver for 12th board exams & CUET coaching.",
          "Additional support for CUET application and university admission fees.",
        ],
      },
      {
  ...
  const review_imgs = [
    ...
    },
    {
      ...
      class: "CUET Aspirant",
      description:
        "Shine made my CUET journey affordable. The scholarship helped me focus on studying without worrying about finances.",
    },
    {
      img: review_img_4,
      name: "Aditi J.",
    ...
    },
    {
      ...
      description:
        "My full scholarship under Shine made my dream of studying at a top university possible. Can’t thank CUET Plus enough!",
    },
    {
      img: review_img_9,
      name: "Akash N.",
  ...
  const faqs = [
    {
      question: "What is the Shine Scholarship Program?",
      answer:
        "The Shine Scholarship Program provides financial aid for CUET Plus’s one-year intensive course, designed exclusively for Class 12 students preparing for CUET and board exams.",
    },
    {
      question: "Who is eligible for the Climb Scholarship?",
      answer:
        "Class 12 students enrolling in the Shine program and performing well in the Scholar Plus Scholarship Test are eligible.",
    },
    {
      question: "Can I get a full scholarship under the Shine Scholarship Program?",
      answer:
        "Yes, top-performing students in the Scholar Plus Scholarship Test can receive up to 100% fee waiver under this program.",
    },
    {
      question: "What are the key features of the Shine Plus program covered by the scholarship?",
      answer:
        "The program includes in-depth CUET preparation, board exam reinforcement, mock tests, and personalized mentorship.",
    },
    {
      question: "How does the Shine Scholarship Program support CUET preparation?",
      answer:
        "The scholarship ensures affordable access to expert faculty, targeted learning resources, and advanced test strategies for CUET success.",
    },
    {
      question: "How can I apply for the Shine Scholarship Program?",
      answer:
        "Students can apply by registering for the Scholar Plus Scholarship Test through CUET Plus’s official website.",
    },
  ];
  const callToActionData = {
    title: "Ready to Excel? Join Shine Now!",
    description:
      "Take the first step toward your academic success. Register today and let CUET Plus guide you to your dream university.",
    buttonText: "Register for Shine Scholarship Test",
  ...
  return (
    <div>
      <Helmet>
        <title>
          SHINE CUET Scholarship Test - Apply for CUET UG SHINE Scholarship
        </title>
        <meta
          name="description"
        ...
        <meta
          property="og:url"
          content="https://cuet.plus/cuet-scholarship/shine-scholarship"
        />
...
export default ShineScholarship;
