  ...
  return (
    <animated.div style={animationSpring} className={styles.componentContainer}>
      ...
      <div className={styles.componentContentBlogs}>
        ...
        <div className={styles.col}>
          <h1 className={styles.componentContentBlogHeading}>Notifications</h1>
          <div className={styles.componentContentBlog}>
            <Swiper
              modules={[Pagination, Autoplay]}
              direction={"vertical"}
...
const StudyAbroad = () => (
  <div className={styles.componentContainer}>
    ...
    <div className={styles.componentContentBlogs} style={{ display: "none" }}>
      <div className={styles.col}>
    ...
    <div className={styles.componentContainer}>
      <div className={styles.componentContent}>
        ...
        <div className={styles.componentContentDesc}>
          ...
          preparation, helping students master effective study techniques,
          manage time, and enhance performance. From seasoned guidance to
          actionable advice, SalahPlus is every student's go-to resource for
          academic success."
        </div>
        <button
          className={styles.componentContentButton}
