...
import satyajeet_cuet_faculty from "../assets/satyajeet_cuet_faculty.jpg";
...
function HomePage() {
  ...
  const faqs2 = [
    {
      question: "How can students benefit from CUET Plus’s free counseling services?",
      answer:
  ...
  const facultyData = [
    {
      img: satyajeet_cuet_faculty,
      name: "Mr. Satyajeet Sir",
      faculty: "(English Faculty)",
      description:
        "With over 20 years of experience in teaching English, Mr. Satyajeet Sir is a renowned name in the world of language education. His approach to teaching goes beyond textbooks, focusing on developing students' comprehension, grammar, and language skills to ensure top results. His students have consistently ranked among India's best, making him highly respected in the field.",
    },
    {
  ...
  return (
    <>
      ...
      >
        <h1 style={{backgroundColor: 'transparent', color:'transparent'}}>Best CUET Coaching in India for Online & Offline Preparation</h1>
        <h2 style={{backgroundColor: 'transparent', color:'transparent'}}>Top CUET coaching centers in India</h2>
      </div>
      ...
      <Link to="/our-courses" style={{ position: "absolute", zIndex: "-200" }}>
        <div className="course-page-btn" style={{color: 'transparent', backgroundColor: 'transparent'}}>Explore CUET Courses</div>
      </Link>
      <CuetBenefit />
      ...
      <HomeStreamCareer />
      <FacultySection
        title="Our CUET Faculty" facultyData={facultyData}
