...
import cardImg1 from "../../../assets/decision-making.png";
import cardImg2 from "../../../assets/target.png";
import cardImg3 from "../../../assets/vitruvian-man.png";
import cardImg4 from "../../../assets/eye-target.png";
import cardImg5 from "../../../assets/target (1).png";
import gsap from "gsap";
import { ScrollTrigger } from "gsap/ScrollTrigger";
import "../../HomePage/CuetBenefit/CuetBenefit.css";
import WorkSection from "../../HomePage/WorkSection/WorkSection";
import CounsellingTestimonial from "../CounsellingTestimonial/CounsellingTestimonial";
...
import nisha_cuet_faculty from "../../../assets/GautamChaudhary.jpg";

import Stream_Counseling from '../../../assets/Stream_Counseling.jpg'
import Career_Counseling from '../../../assets/Career_Counseling.jpg'
  ...
  const facultyData = [
    {
      ...
      name: "Mr. Gautam Chaudhary",
      faculty: "(Stream Counselor)",
      description:
        "With over a decade of experience in educational counseling, Mr. Gautam Chaudhary has guided countless students in choosing the right academic streams to match their strengths, interests, and aspirations. He understands that selecting the right stream after Class 10 is a crucial decision for students.",
    },
    {
      img: anand_cuet_faculty,
      name: "Mr. Anand Jha",
      faculty: "(Career Counselor)",
      description:
        "A respected name in career counseling, Mr. Anand has spent over 10 years helping students navigate the complexities of career planning. He specializes in providing clarity to students of Classes 11 and 12, assisting them in identifying suitable career paths based on their skills, passions, and ambitions.",
    },
  ];
    ...
    <div className={styles.counsellingPage}>
      ...
      <div className={styles.counselingServices}>
        ...
        <div className={styles.plusContainer}>
          {[
            {
              img: Stream_Counseling,
              title: (
                <>
                  <h3 className={styles.orangeText}>Disha Plus</h3>
                 Stream Counseling
                </>
              ),
            ...
            {
              img: Career_Counseling,
              title: (
                <>
                  <h3 className={styles.orangeText}>Vision Plus</h3>
                  Career Counseling
                </>
              ),
            ...
            <div key={index} className={styles.plusCard}>
              <img src={service.img} alt={service.title} className={`${styles.img} ${styles.plusImg}`} />
